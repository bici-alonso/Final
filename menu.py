...
def menu ():
    ...
    while (pregunta == 1):
        ...
        if opcion == 1: 
            ...
            rpaciente11 = Receptor("Valentina Rossi", 48012345, date(2002, 5, 10), "F", "1112345678", "1123456789", "A+", "Hospital Italiano", "Receptor", "02", "24", "01", "02", "11", "22", ["riñón"], date(2024, 6, 1), "insuficiencia renal", "inestable")
