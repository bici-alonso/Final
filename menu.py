...
def menu ():
    ...
    while (pregunta == 1):
        ...
        if opcion == 1: 
            ...
            paciente2=Receptor("Victoria", 46821487, "25/03/2005", "F", 1135857168, 1158694552, "0+", "Favaloro", "Receptor", org_recib="Corazon", fecha_list_esp="15/05/2024", patologia="cardiopatía", estado="inestable")
            ...
            nombres = Centro_de_salud.nombrar_centros()
